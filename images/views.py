...
def image(request,image_id):
    try:
        ...
        raise Http404()
    return render(request,'insta/image.html',{'image':image})
...
def search_profile(request,profile_id):
    try :
        ...
        # raise Http404()
        return render(request, 'insta/no_profile.html')

    return render(request, 'insta/search_profile.html', {'profile':profile})
